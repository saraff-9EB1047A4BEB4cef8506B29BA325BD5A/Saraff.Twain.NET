...
namespace Saraff.TwainX {
    ...
    public sealed class TwainX:Component {
            ...
            get{
                if(this._appid==null) {
                    ...
                    this._appid = new TwIdentity() {
                        ...
                        ProductName = (Attribute.GetCustomAttribute(_asm, typeof(AssemblyProductAttribute), false) as AssemblyProductAttribute)?.Product ?? "Saraff.TwainX.NET"
                    };
                }
                return this._appid;
            }
        ...
        private void _OnAcquireCompleted(EventArgs e) {
            this.AcquireCompleted?.Invoke(this, e);
        }

        private void _OnAcquireError(AcquireErrorEventArgs e) {
            this.AcquireError?.Invoke(this, e);
        }
        ...
        private void _OnDeviceEvent(DeviceEventEventArgs e) {
            this.DeviceEvent?.Invoke(this, e);
        }
