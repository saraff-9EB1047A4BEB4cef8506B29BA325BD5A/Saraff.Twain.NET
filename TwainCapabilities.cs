...
namespace Saraff.Twain {
    ...
    public sealed class TwainCapabilities : MarshalByRefObject {
        private readonly Dictionary<TwCap, Type> _caps = new Dictionary<TwCap, Type>();
        ...
        private Capability<T> CreateCapability<T>(TwainX twain, TwCap cap) => Activator.CreateInstance(typeof(Capability<T>), new object[] { twain, cap }) as Capability<T>;
        ...
        private class Capability<T> : ICapability<T>, ICapability2<T> {
            ...
            public TwainX.Enumeration Get() => this.ToEnumeration(this._Twain32.GetCap(this._Cap));
            ...
            protected TwainX _Twain32 { get; private set; }
